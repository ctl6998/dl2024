...
class MaxPooling(Layer):
    ...
    def forward(self, input_data):
        ...
        # if self.log:
        #     print("Forward pass of MaxPooling layer:")
    ...
    def backward(self, output_gradient, learning_rate):
        ...
        # if self.log:
        #     print("Backward pass of MaxPooling layer:")
        #     print("Output gradient shape:", self.output_shape())
        #     print("Input gradient shape:", self.input_shape())
